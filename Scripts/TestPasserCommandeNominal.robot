...
Documentation     Tester la fonctionalite de passer la comande. Le systeme doit permettre de passer une commande avec un produit valide.
...
${message_erreur_choix}    Choix doit etre seulement Sony VAIO ou iMac
